...
public class Hexagon extends HexComponent {
	...
	public static enum HexType {
		WALL, START, END, EMPTY, START_PROCESSED, END_PROCESSED, START_DEQUEUED, ENQUEUED, DEQUEUED, DRAGON, LAVA, CACTI, PATH
	};
	...
	private Hexagon predecessor; // Predecessor in the shortest path to exit
